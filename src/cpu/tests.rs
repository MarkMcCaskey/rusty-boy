...
test_op_really_no_arg!(cpl_test1,
                       cpl,
                       CpuRegister::A,
                       0x15,
                       0xEA,
                       |flags| flags & (NLV | HL),
                       (NLV | HL));
test_op_really_no_arg!(cpl_test2,
                       cpl,
                       CpuRegister::A,
                       0x70,
                       0x8F,
                       |flags| flags & (NLV | HL),
                       (NLV | HL));
test_op_really_no_arg!(cpl_test3,
                       cpl,
                       CpuRegister::A,
                       0xFF,
                       0x00,
                       |flags| flags & (NLV | HL),
                       (NLV | HL));
test_op_really_no_arg!(cpl_test4,
                       cpl,
                       CpuRegister::A,
                       0x00,
                       0xFF,
